...
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
link:rapport/RapportDeComparaisonsSansEspacesPourNePasDerrangerAsciidoc.pdf[Rapport]
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
| 1    | link:src/main/java/eraser/Simple.java[ici]  | Java     | Simplicité
| 2    | link:src/main/java/eraser/Efficace.java[ici]| Java     | Efficacité
| 3    | link:solution.py[ici]| Python     | Simplicité
|==========================================================================
...
. Installez Java 1.8
. Lancez analyse\Java\src\tests\Test.java et analyse\Java\src\tests\EraserTest.java
. Installez Python 3.7
. Lancez analyse\Python\analyse.py et analyse\Python\test.py
. Créez un Replit
. Téléverser analyse\C\analyse.c, analyse\C\main.c, analyse\C\test.c, analyse\C\sobriete_136.c
. Cliquez sur "Run"

=== Références

- link:https://junit.org/junit4/[JUnit 4 pour Java]
- link:https://www.java.com/fr/download/[Java 1.8]
- link:https://www.python.org/downloads/release/python-379/[Python 3.7]
- link:https://replit.com[Replit]
